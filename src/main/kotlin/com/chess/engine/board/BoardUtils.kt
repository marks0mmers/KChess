...
object BoardUtils {
    ...
    private const val NUM_TILES_PER_ROW = 8
    ...
    val SECOND_ROW = initRow(8)
    val THIRD_ROW = initRow(16)
    val FOURTH_ROW = initRow(24)
    val FIFTH_ROW = initRow(32)
    val SIXTH_ROW = initRow(40)
    val SEVENTH_ROW = initRow(48)
    val EIGHTH_ROW = initRow(56)
    ...
    private fun initRow(columnNumber: Int) = TILES_RANGE.map {
        it in (NUM_TILES_PER_ROW * columnNumber) until NUM_TILES_PER_ROW * (columnNumber + 1)
    }
